...
source_latitude,source_longitude=get_geocodes_from_here_maps("Dallas, TX")                    #Sample source
destination_latitude,destination_longitude=get_geocodes_from_here_maps("Newyork, NY")         #Sample destination
